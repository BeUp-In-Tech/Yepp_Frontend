                ...
                <div className="flex flex-col h-full py-3 pl-2">
                    ...
                    <nav className="flex-1">
                        <ul className='space-y-2 pr-5 mt-4 pl-3.5'>
                            <p className='text-[#4BBDCF] font-semibold text-lg'>Main</p>
                            <NavLink to='/dashboard/admin-dashboard' className={({ isActive }) => `flex items-center gap-1 w-full py-3 ease-in-out text-base font-semibold hover:bg-[#F9F0FF] hover:text-[#00444E] hover:border-[#4BBDCF] hover:border-l-8 hover:rounded-sm  ${isActive ? 'bg-[#F9F0FF] py-2 pl-3 rounded-sm text-[#00444E] border-l-8 border-[#4BBDCF]' : 'pl-3 text-white'}`}>
                        ...
                        <ul className='space-y-2 pr-5 mt-4 pl-3.5'>
                            <p className='text-[#4BBDCF] font-semibold text-lg'>Management</p>
