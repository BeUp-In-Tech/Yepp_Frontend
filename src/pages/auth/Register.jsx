                ...
                <div className="w-full max-w-120 bg-white rounded-xl shadow-sm p-4 sm:p-10 border-slate-100">
                    ...
                    <div className="flex bg-[#F0F9FF] rounded-full mb-8 max-w-68.5 mx-auto">
                        <div className="w-full p-1.5 flex">
                            ...
                            <Link to='#' className="text-center w-full py-2 px-4 rounded-full bg-[#4FC3D4] hover:bg-[#3db0c1] text-white text-base font-medium cursor-pointer">
                                Sign up
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="text-center mt-8 text-base">
                        ...
                        <Link to="/login" className="text-[#2B9DAE] font-semibold hover:underline">
                            Log in
                        </Link>
                    </div>
                </div>
