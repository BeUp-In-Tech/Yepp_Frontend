    ...
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white h-auto rounded-2xl w-full max-w-lg p-8 shadow-2xl">
        <div className="flex justify-between items-center mb-6">
          <h3 className="text-2xl font-bold text-[#2B9DAE]">Add Outlet</h3>
        ...
        <div className="space-y-5">
          ...
          <div className="flex gap-4 pt-4">
            ...
            <button
              ...
              onClick={handleSave}
              className={`flex-1 py-3 rounded-full cursor-pointer ${coordinates === null ? 'bg-gray-300 text-gray-800' : 'bg-[#4BBDCF] text-white'}`}
            >
              Save Outlet
            </button>
